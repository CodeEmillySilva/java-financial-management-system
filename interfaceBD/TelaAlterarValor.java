...
public class TelaAlterarValor extends JFrame{
	
	private static final int DEFAULT_WIDTH=1000;
	private static final int DEFAULT_HEIGHT=1000;
	
	public TelaAlterarValor (int idGasto, Usuario usuario) {

		this.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		this.setSize(DEFAULT_WIDTH, DEFAULT_HEIGHT);
	
		JLabel titulo = new JLabel("ALTERAÇÃO DO VALOR DO GASTO");
		...
		botao2.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
					...
					boolean check = gastoBD.alterarGastoParcialmente(usuario, idGasto, 4, valorReal);
	...
	public boolean verificarVazio(String valor) {
